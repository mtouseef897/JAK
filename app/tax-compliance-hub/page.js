...
export default function TaxComplianceHubPage() {
  ...
  const taxContent = {
    pk: {
      ...
      services: [
        "Income Tax Return (ITR) filing for salaried individuals",
        "Corporate tax filing and compliance for companies",
        "Sales Tax (GST) registration and monthly filing",
        "Withholding tax compliance and reconciliation",
        "FBR registration and Active Taxpayer List (ATL) management",
        "Tax audit representation and dispute resolution",
        "Provincial taxes (SWAT, SECP, etc.)",
      ],
    },
    us: {
      name: "United States",
