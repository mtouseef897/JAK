    ...
    >
      <div className="container h-100">
        <div className="row align-items-center h-100">
          ...
          >
            <div className="fs-70 lh-75 sm-fs-65 fw-600 mb-20px text-shadow-large ls-minus-2px">
             Trusted Accounting, Tax & Financial Experts for Pakistan, USA, KSA, UK & UAE
            </div>
            <div>
              <span className="opacity-5 fs-20 w-70 md-w-85 mb-25px fw-300 d-inline-block">
                JAK delivers end-to-end accounting, tax compliance, audit, and financial advisory — 100% remote, serving clients across four jurisdictions.
              </span>
            </div>
       <div  style={{
        display:"flex",
